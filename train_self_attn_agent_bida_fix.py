...
from models.self_attention_agent_bida_fix import AgentBiDA  # UPDATED IMPORT
...
if __name__ == "__main__":
    ...
    model_dir = "./checkpoints/self_attn_agent_bida/" + opts.source_name + 'to' + opts.target_name + f"_agents{opts.num_agents}_heads{opts.num_heads}"
