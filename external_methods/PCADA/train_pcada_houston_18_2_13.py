...
data_path_s = '../../Houston/Houston18.mat'
label_path_s = '../../Houston/Houston18_7gt.mat'
data_path_t = '../../Houston/Houston13.mat'
label_path_t = '../../Houston/Houston13_7gt.mat'
...
res_dict = {
    'OA': float(OAMean), 
    'AA': float(AAMean * 100),
    'Kappa': float(kMean * 100),
    'classes': {str(c+1): float(AMean[c] * 100) for c in range(CLASS_NUM)}
}
os.makedirs('../../ablation_results', exist_ok=True)
json_path = os.path.join('../../ablation_results', f"PCADA_results_seed_{args.seed}.json")
